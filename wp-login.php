...
<html lang="en-US">
	...
	<title>Log In &lsaquo; learnindigital &#8212; WordPress</title>
...
<meta name="generator" content="Site Kit by Google 1.72.0">	<meta name="referrer" content="strict-origin-when-cross-origin">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="http127.0.0.1/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http127.0.0.1/wordpress/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to learnindigital</a>		</p>
			</div>
			<script type="text/javascript" src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script type="text/javascript" src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script type="text/javascript" id="zxcvbn-async-js-extra">
/*  */
var _zxcvbnSettings = {"src":"http127.0.0.1\/wordpress\/wp-includes\/js\/zxcvbn.min.js"};
/*  */
</script>
...
/*  */
var userProfileL10n = {"user_id":"0","nonce":"8692164bab"};
/*  */
</script>
